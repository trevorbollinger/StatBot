  ...
  return (
    <div className="message-stats-container fade-in">
      <div className="card-container">
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.total_messages)}
        >
        ...
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.total_words)}
        >
        ...
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.total_characters)}
        >
        ...
        <div
          className="stat-card"
          onClick={() =>
            handleStatClick(stats.total_words / stats.total_messages, true)
          }
        >
          <div className="stat-label">Average Words / Message</div>
          <div className="stat-number">
            {stats.total_messages > 0
              ? (stats.total_words / stats.total_messages).toFixed(1)
              : 0}
          </div>
        </div>
        <div
          className="stat-card"
          onClick={() =>
            handleStatClick(stats.total_characters / stats.total_messages, true)
          }
        >
          <div className="stat-label">Average Chars / Message</div>
          <div className="stat-number">
            {stats.total_messages > 0
              ? (stats.total_characters / stats.total_messages).toFixed(1)
              : 0}
          </div>
        </div>
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.most_active_day?.count)}
        >
          <div className="stat-label">Most Active Day</div>
          <div className="stat-number">
            {stats.most_active_day
              ? `${new Date(
                  stats.most_active_day.date
        ...
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.least_active_day?.count)}
        >
          <div className="stat-label">Least Active Day</div>
          <div className="stat-number">
            {stats.least_active_day
              ? `${new Date(
                  stats.least_active_day.date
                ).toLocaleDateString()}: ${formatNumber(
        ...
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.average_messages_per_day)}
        >
          <div className="stat-label">Average Per Day</div>
          <div className="stat-number">
            {formatNumber(stats.average_messages_per_day)}
          </div>
        </div>
        <div
          className="stat-card"
          onClick={() => handleStatClick(stats.messages_last_24_hours)}
        >
          <div className="stat-label">Messages Last 24h</div>
          <div className="stat-number">
            {formatNumber(stats.messages_last_24_hours)}
          </div>
        </div>
      </div>
