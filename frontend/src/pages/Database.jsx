...
const Database = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      if (filters.server)
        url += `&server=${encodeURIComponent(filters.server)}`;
      if (filters.channel)
  ...
  const PaginationControls = () => (
    <div className="pagination-container">
      <div className="button-row">
        <button onClick={handleRefresh} className="button blue-button">
          Refresh
        </button>
        <button
  ...
  const FilterControls = () => {
    ...
    const allCategorizedChannels = channelCategories.flatMap(
      (cat) => cat.channels
    );
            ...
            <div className="toggle-container">
              <label className="toggle">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, hasMention: e.target.checked }))
                  }
                />
                <span className="custom-checkbox"></span>
              </label>
            ...
            <div className="toggle-container">
              <label className="toggle">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, hasEmoji: e.target.checked }))
                  }
                />
                <span className="custom-checkbox"></span>
              </label>
